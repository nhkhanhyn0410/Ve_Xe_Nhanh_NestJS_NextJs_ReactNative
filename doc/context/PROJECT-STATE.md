...
| 02     | HLD - High Level Design                   | `vi/SDLC/02-hld-he-thong-dat-ve-xe-khach.md`           | v1.5    | Approved | AI Agent, Nguyễn Hồng Khanh        |
...
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | ---------- |
| 02-HLD                          | v1.8 đã khắc phục lỗi review nội bộ: đồng bộ version, mobile User-only, HLD-OQ-01 storage và trạng thái HLD-OQ-02..04; còn cần người duyệt xác nhận và xử lý / chấp nhận HLD-OQ-02..04 trước khi các tài liệu DB/API/Security/Deployment chốt chi tiết. | AI Agent | 12/05/2026 |
...
| SDLC docs 03..11 are v0.1 skeletons; 02-HLD v1.8 has synced §1..§18 but remains Draft pending reviewer confirmation and HLD-OQ-02..04 handling | Continue rewrite / review in dependency order: 04-DB → 05-API → 07-Security → 08-Test → 09-Deployment → 11-Task Breakdown. | Pending |
