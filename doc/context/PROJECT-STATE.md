...
| 02     | HLD - High Level Design                   | `vi/SDLC/02-hld-he-thong-dat-ve-xe-khach.md`           | v1.12   | Approved | AI Agent, Nguyễn Hồng Khanh        |
| 03     | LLD - Low Level Design                    | `vi/SDLC/03-lld-he-thong-dat-ve-xe-khach.md`           | v1.1    | Approved | AI Agent                           |
| 04     | Database Design                           | `vi/SDLC/04-database-design.md`                        | v0.2    | Draft    | AI Agent                           |
...
| 10     | Architecture Decision Record              | `vi/SDLC/10-architecture-decision-record.md`           | v0.4    | Draft    | AI Agent                           |
...
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------- | ---------- |
| 02-HLD                          | v1.12 đã đóng HLD-OQ-01 và HLD-OQ-04; còn cần người duyệt xử lý HLD-OQ-03 và review tổng thể trước khi chuyển trạng thái.                                          | AI Agent | 12/05/2026 |
| 03-LLD                          | v1.1 đã đóng LLD-OP-01..06; trước khi code transaction core, DB Design phải cụ thể hóa DB-authoritative hybrid cho SeatHold và Test Plan phải có concurrency test. | AI Agent | 12/05/2026 |
| 10-ADR                          | ADR 10 v0.4 đã đóng ADR-OQ-05 theo hướng mở lại lựa chọn tech stack sau khi downstream docs đủ rõ; target implementation stack vẫn chưa được `Accepted`.           | AI Agent | 12/05/2026 |
| 04-Database Design              | v0.2 đã đồng bộ quyết định SeatHold/storage nhưng vẫn chưa đủ collection / index / TTL / idempotency / ledger / audit-retention để triển khai dữ liệu V1.          | AI Agent | 12/05/2026 |
...
| SDLC docs 04..09 and 11 remain incomplete; 04 and 07 have only partial decision sync, not full design | Continue rewrite / review in dependency order: 04-DB → 05-API → 07-Security → 08-Test → 09-Deployment → 11-Task Breakdown, with tech stack target accepted before code. | Pending |
