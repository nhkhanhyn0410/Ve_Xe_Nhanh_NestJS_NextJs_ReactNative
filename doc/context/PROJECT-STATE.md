...
| ------ | ----------------------------------------- | ------------------------------------------------------ | ------- | -------- | ---------------------------------- |
| 00     | Quy chuẩn SDLC cho lập trình viên         | `vi/SDLC/00-quy-chuan-cho-lap-trinh-vien.md`           | v1.0    | Approved | Nguyễn Hồng Khanh                  |
| 00-AI  | Quy chuẩn SDLC cho AI agent (Vietnamese)  | `vi/agent/00-quy-chuan-cho-ai-agent.md`                | v1.0    | Approved | Nguyễn Hồng Khanh                  |
| 00b-EN | SDLC Standards for AI agent (English)     | `en/agent/00-standard-for-ai-agent.md`                 | v1.0    | Draft    | Nguyễn Hồng Khanh                  |
| 01     | SRS - Software Requirements Specification | `vi/SDLC/01-srs-he-thong-dat-ve-xe-khach.md`           | v1.20   | Approved | AI Agent, Nguyễn Hồng Khanh + team |
| 02     | HLD - High Level Design                   | `vi/SDLC/02-hld-he-thong-dat-ve-xe-khach.md`           | v1.13   | Approved | AI Agent, Nguyễn Hồng Khanh        |
| 03     | LLD - Low Level Design                    | `vi/SDLC/03-lld-he-thong-dat-ve-xe-khach.md`           | v1.2    | Approved | AI Agent, Nguyễn Hồng Khanh        |
| 04     | Database Design                           | `vi/SDLC/04-database-design.md`                        | v1.4    | Approved | AI Agent                           |
| 05     | API Specification                         | `vi/SDLC/05-api-specification.md`                      | v1.1    | Approved | AI Agent                           |
| 06     | UI / UX Flow Specification                | `vi/SDLC/06-ui-ux-flow-specification.md`               | v0.1    | Draft    | AI Agent                           |
| 07     | Security & Permission Design              | `vi/SDLC/07-security-permission-design.md`             | v0.2    | Draft    | AI Agent                           |
...
| 10     | Architecture Decision Record              | `vi/SDLC/10-architecture-decision-record.md`           | v0.5    | Draft    | AI Agent                           |
...
| API-OP-01 | Auth/session transport chính thức: Bearer token, secure cookie, refresh credential, re-auth challenge shape, MFA cho Admin/Operator nếu có.                               | AI Agent  | 13/05/2026 | Ảnh hưởng FE/Mobile auth, CSRF/CORS, secure storage, refresh/revoke test và Security Design.   | Open              |
| API-OP-02 | Realtime transport, auth handshake, topic naming vật lý và fallback khi mất kết nối.                                                                                      | AI Agent  | 13/05/2026 | Ảnh hưởng Web/Mobile realtime client, scaling, reconnect và authorization event.               | Open              |
| API-OP-03 | VNPay Sandbox exact callback/return parameter mapping, signature validation detail, secret rotation và allowlist source.                                                  | AI Agent  | 13/05/2026 | Ảnh hưởng payment callback, reconciliation, security review và test sandbox.                   | Open              |
| API-OP-04 | Notification provider/template/retry policy chi tiết và push token registry nếu push được bật ở V1 launch.                                                                | AI Agent  | 13/05/2026 | Ảnh hưởng mobile push, email delivery, retry budget, consent/preference và notification test.  | Open              |
| API-OP-05 | API contract publication tooling: OpenAPI là source generated từ tài liệu hay từ code, SDK client generation, schema versioning policy.                                   | AI Agent  | 13/05/2026 | Ảnh hưởng FE/Mobile integration workflow, contract test và CI validation.                      | Open              |
...
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------- | ---------- |
| 10-ADR                          | ADR 10 v0.5 đã Accepted operational database target qua ADR-003; backend framework, queue/cache engine, deployment target và observability stack vẫn chưa được Accepted. | AI Agent | 13/05/2026 |
| 05-API Specification            | API 05 v1.0 đã đủ contract logic từ Approved docs; còn API-OP-01..05 cần reviewer/Security/ADR chốt trước khi chuyển Review/Approved.                                    | AI Agent | 13/05/2026 |
| 07-Security & Permission Design | v0.2 đã đồng bộ storage provider nhưng chưa đủ rule chi tiết cho RBAC, tenant boundary, Guest lookup, masking, audit và thao tác nhạy cảm.                               | AI Agent | 12/05/2026 |
| 08-Test Plan                    | Chưa chuyển AC-01..AC-35 của SRS v1.20 thành test case / test data / entry-exit criteria cụ thể.                                                                         | AI Agent | 12/05/2026 |
...
| SDLC docs 06..09 and 11 remain incomplete; 05 remains Draft with API-OP-01..05 open | Resolve API-OP-01..05 when reviewer is ready, then continue downstream rewrite / review in dependency order: 06-UI/UX → 07-Security → 08-Test → 09-Deployment → 11-Task Breakdown. | Pending |
