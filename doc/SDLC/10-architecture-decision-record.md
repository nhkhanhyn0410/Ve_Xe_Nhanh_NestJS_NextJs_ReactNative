...
| ID        | Vấn đề                                                                                                                                       | Chặn                           | Trạng thái       |
| --------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------ | ---------------- | ---------------- |
| ADR-OP-01 | ĐÃ CHỐT: xác nhận ADR-010 nếu muốn coi NestJS + TypeScript là target implementation chính thức, không chỉ là dependency/candidate trong SRS. |                                | Code convention  | Close 13/05/2026 |
| ADR-OP-02 | ĐÃ CHỐT: xác nhận ADR-011 nếu muốn chốt Redis + Bull/BullMQ-compatible queue làm backend queue/cache target.                                 | Worker/queue implementation    | Close 13/05/2026 |
| ADR-OP-03 | ĐÃ CHỐT: tùy tình huống.                                                                                                                     | Production release             | Close 13/05/2026 |
| ADR-OP-04 | ĐÃ CHỐT: Exact Node.js/npm/package manager/Docker image version đã chốt trong tài liệu Approved.                                             | CI/reproducibility             | Close 13/05/2026 |
| ADR-OP-05 | ĐÃ CHỐT: V1 chỉ có email/in-app baseline và sandbox/mock cho test.                                                                           | Transactional email production | Close 13/05/2026 |
