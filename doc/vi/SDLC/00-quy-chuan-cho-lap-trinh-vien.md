...
| ----------- | ----------------------------------------- | ---------------------------- | ------------------------------------- | ----------------------------------------------------------------------------- | ----------------------------------------------------------- | --- |
| 00          | Quy chuẩn SDLC cho lập trình viên         | Policy / Procedure           | `00a-quy-chuan-cho-lap-trinh-vien.md` | Quy định cách lập trình viên dùng tài liệu SDLC làm nguồn triển khai          | Approved                                                    |     |
